		...
		return (
			<Card>
				<CardHeader>
					...
					<CardDescription>Biggest blowouts and closest games (2019+)</CardDescription>
				</CardHeader>
				<CardContent>
			...
			<CardHeader>
				<div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
					<div>
						...
						<CardDescription>
							{viewMode === 'blowouts'
								? 'Largest margin of victory in league history (2019+)'
								: 'Nail-biters decided by the smallest margins (2019+)'}
						</CardDescription>
					</div>
